...
//  VidmeUnofficial
//
//  Created by Edward White on 5/2/17.
//  Copyright © 2017 EdwardWhite. All rights reserved.
//
...
class HomeViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    class VideoCell: UICollectionViewCell {
        ...
        func setupView(){
            ...
            addConstraintsWithFormat(format: "H:|-16-[v0]-16-|", views: thumbnailImageView, separatorView)
